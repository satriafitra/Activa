            ...
            child: SafeArea(
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(
                            'assets/images/sidebar_banner.png'), // ganti sesuai filemu
                        fit: BoxFit.cover,
                      ),
                      ...
                      children: [
                        Text(
                          ...
                          style: GoogleFonts.poppins(
                            ...
                            decoration: TextDecoration.none, // ✨ ini penting
                          ),
                        ),
                        SizedBox(height: 24),
                        Text(
                  ...
                  _SidebarMenuItem(Icons.face_retouching_natural, "Acto's Pal",
                      trailing: "NEW", isActive: selectedItem == "Acto's Pal"),
                  _SidebarMenuItem(Icons.settings, "Settings",
                      isActive: selectedItem == "Settings"),
                  _SidebarMenuItem(Icons.person, "Profile",
                      isActive: selectedItem == "Profile"),
                  _SidebarMenuItem(Icons.diamond_outlined, "Premium Plan",
                      trailing: "HOT",
                      isActive: selectedItem == "Premium Plan"),
                ],
              ),
            ),
          ),
...
class _SidebarMenuItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bgColor =
        isActive ? Colors.blue.withOpacity(0.08) : Colors.transparent;
